...
describe('prompts/execute', () => {
  describe('buildExecutePrompt', () => {
    ...
    it('should calculate push deadline correctly', () => {
      ...
      expect(result).toContain('You have **50 turns** total. Reserve the last 5 turns for push + PR creation.');
    ...
    it('should include turn budget strategy instructions', () => {
      ...
      expect(result).toContain('Push early and create a draft PR after completing 2-3 implementation steps');
    ...
    it('should include step-by-step implementation instructions', () => {
      ...
      expect(result).toContain('Make an atomic commit with a clear message: `step N: <description>`');
    ...
    it('should include important rules about dependencies', () => {
      ...
      expect(result).toContain('Do NOT run typecheck or build commands unless the project already has dependencies installed');
