...
describe('prompts/plan', () => {
  describe('buildPlanPrompt', () => {
    ...
    it('should build a complete plan prompt with all sections', () => {
      ...
      expect(result).toContain('You are analyzing a GitHub issue to create an implementation plan.');
    ...
    it('should include PLAN_HEADER and PLAN_FOOTER', () => {
      ...
      const headerCount = (result.match(new RegExp(PLAN_HEADER.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'), 'g')) || []).length;
